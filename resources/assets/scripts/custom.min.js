$(document).on("turbolinks:load", function () {
    $(function () {
        ...
        $("body").trigger("resize"), $(".list-task li label").click(function () {
            ...
            $(this).hasClass('is-invalid') ? $(this).removeClass('is-invalid') : '';
        }), $('input[name="a_name"]').on("focusout", function () {
            //$(this).val().indexOf(' ') >= 0 ? $(this).addClass('is-invalid').parents('.form-group').find('.invalid-feedback').text('Spaces are not allowed'): '';
